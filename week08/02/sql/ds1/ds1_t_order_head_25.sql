...
--
-- Table structure for table `t_order_head_25`
--

DROP TABLE IF EXISTS `t_order_head_25`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `t_order_head_25` (
...
) ENGINE=InnoDB AUTO_INCREMENT=9978 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='订单头信息';
...
-- Dump completed on 2021-06-26 16:08:05
