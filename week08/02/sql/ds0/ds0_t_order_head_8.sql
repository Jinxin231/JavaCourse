...
--
-- Table structure for table `t_order_head_8`
--

DROP TABLE IF EXISTS `t_order_head_8`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `t_order_head_8` (
...
) ENGINE=InnoDB AUTO_INCREMENT=9993 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='订单头信息';
...
-- Dump completed on 2021-06-26 16:07:59
